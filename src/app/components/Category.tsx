    ...
    return (
        <>
            ...
            justify-between items-center z-10 bg-white text-custom-dark-blue relative'>
                                ...
                                <a href="/blog1" className='bg-custom-dark-blue px-4 py-2 justify-start p-2 m-2 rounded text-white hover:bg-blue-900'>Read more</a>
                            </div>
